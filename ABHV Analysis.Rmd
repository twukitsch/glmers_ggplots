...
And I have performed my coding adjustments. However, we still need to further prepare our data to avoid issues during analysis such as problems with variance inflation. If we mean-center the continuous variables that will be predictors in an LMER or GLMER model, we tend to have situations where the variance inflation factor remains within a tolerable range and doesn't affect results.
